...
class HelpdeskTicket(models.Model):
    ...
    positive_rate_percentage = fields.Integer(
        string="Porcentaje de valoraciones positivas",
    ...
    rating_status = fields.Selection(
        selection=[
            ("stage_change", "Valoración al cambiar de etapa"),
            ("no_rate", "Sin valoración"),
        ],
        string="Valoración del cliente",
    ...
    def action_view_ticket_rating(self):
        ...
        action["name"] = _("Valoración del ticket")
