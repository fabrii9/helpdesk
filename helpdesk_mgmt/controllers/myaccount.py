...
class CustomerPortalHelpdesk(CustomerPortal):
    ...
    def _ticket_get_searchbar_sortings(self):
        return {
            "date": {
                "label": request.env._("Más reciente"),
                "order": "create_date desc",
                "sequence": 1,
            },
            "name": {"label": request.env._("Título"), "order": "name", "sequence": 2},
            "stage": {
                "label": request.env._("Etapa"),
                "order": "stage_id",
                "sequence": 3,
            },
            "update": {
                "label": request.env._("Última actualización de etapa"),
    ...
    def _ticket_get_searchbar_groupby(self):
        values = {
            "none": {"input": "none", "label": request.env._("Ninguno"), "order": 1},
            "category": {
                "input": "category",
                "label": request.env._("Categoría"),
                "order": 2,
            },
            "stage": {"input": "stage", "label": request.env._("Etapa"), "order": 3},
        }
    ...
    def _ticket_get_searchbar_inputs(self):
        values = {
            "all": {
                "input": "all",
                "label": request.env._("Buscar en todo"),
                "order": 1,
            },
            "number": {
                "input": "number",
                "label": request.env._("Buscar en Número"),
                "order": 2,
            },
            "name": {
                "input": "name",
                "label": request.env._("Buscar en Título"),
                "order": 3,
            },
        }
        return dict(sorted(values.items(), key=lambda item: item[1]["order"]))
