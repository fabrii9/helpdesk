...
class HelpdeskTicket(models.Model):
    ...
    res_model = fields.Char(string="Modelo del documento fuente", index=True)
    res_id = fields.Integer(string="Documento fuente", index=True)
    ...
    date_deadline = fields.Date(string="Fecha límite", default=fields.Date.today)
    ...
    def perform_action(self):
        ...
        return {
            ...
            "params": {
                "type": "success",
                "message": _("\u00a1La actividad ha sido creada!"),
